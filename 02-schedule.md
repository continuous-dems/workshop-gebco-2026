...
| 11:30 AM–1:00 PM | Lunch | offsite |
| 1:00–1:40 PM | Vertical Harmonization with `transformez` | Review vertical datums, reference frames, harmonization, and shift-grid workflows. |
| 1:40–2:20 PM | Workflow Synthesis with `globato` | Review how source modules, transformations, stacking, interpolation, and outputs are connected. |
| 2:20–2:50 PM | Custom Region Exercise | Inspect or modify a YAML recipe, run a workflow for another coastal region, and review the outputs. |
